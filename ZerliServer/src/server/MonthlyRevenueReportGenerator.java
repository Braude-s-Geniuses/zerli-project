...
public class MonthlyRevenueReportGenerator extends MonthlyReportGenerator {

    private ArrayList<String> revenueColumns =new ArrayList<String>();

    public MonthlyRevenueReportGenerator(String branch, String month, String year, String type) {
