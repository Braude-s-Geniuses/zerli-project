...
public class QuarterlyRevenueReportGenerator extends QuarterlyReportGenerator{

    public QuarterlyRevenueReportGenerator(String branch, String quarter, String year, String type) {
