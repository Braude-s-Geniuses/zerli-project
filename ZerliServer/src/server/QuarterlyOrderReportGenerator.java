...
public class QuarterlyOrderReportGenerator extends QuarterlyReportGenerator{


    private  ArrayList<String> orderColumns = new ArrayList<String>();

    public QuarterlyOrderReportGenerator(String branch, String quarter, String year, String type) {
